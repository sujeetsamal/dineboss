...
import { Pencil, Trash2, UtensilsCrossed, Upload, X } from "lucide-react";
...
function categoryBadge(category) {
  ...
  if (value === "dessert") return "badge-purple";
  return "badge-amber";
}
      ...
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            className="input-gold px-4 py-2 text-sm"
          />
      ...
      {!authLoading && !loadingItems && items.length > 0 ? (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredItems.length === 0 ? (
            ...
            return (
              <div key={item.id} className="card relative overflow-hidden p-5">
                <div className="mb-3 h-32 w-full rounded-lg overflow-hidden bg-border-theme flex items-center justify-center">
                  {item.imageUrl ? (
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/60 p-4">
          <form onSubmit={handleSubmit} className="card w-full max-w-lg p-5">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="mb-1 block text-sm text-text-secondary">Image</label>
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="flex-1 rounded-lg border border-border-theme px-3 py-2 text-sm flex items-center justify-center gap-2 hover:border-gold transition"
                  >
                ...
                {(imageFile || form.imageUrl) && (
                  <div className="mt-2 h-24 w-full rounded-lg overflow-hidden bg-border-theme">
                    <img
