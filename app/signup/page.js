...
import { initializeDomainFields } from '@/lib/domains';
...
export default function SignupPage() {
  ...
  async function handleSignup(e) {
    ...
    try {
      ...
      // STEP 1: Create USER DOCUMENT FIRST (needed for Firestore rules)
      ...
      // STEP 2: Create RESTAURANT DOCUMENT (now user exists)
      await setDoc(restaurantRef, {
        ...
        plan: 'free',
        orderLimitPerDay: 50,
        // Domain fields will be initialized next
      });
      
      // STEP 3: Initialize domain fields (auto-assign subdomain)
      await initializeDomainFields(restaurantId, form.restaurantName);
